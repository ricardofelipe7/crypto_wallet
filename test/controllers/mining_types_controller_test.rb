...
class MiningTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mining_type" do
    assert_difference("MiningType.count") do
      post mining_types_url, params: { mining_type: { acronym: @mining_type.acronym, description: @mining_type.description, string: @mining_type.string } }
    end
  ...
  test "should update mining_type" do
    patch mining_type_url(@mining_type), params: { mining_type: { acronym: @mining_type.acronym, description: @mining_type.description, string: @mining_type.string } }
